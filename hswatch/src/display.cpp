...
void Display::drawProgressBar(uint16_t x, uint16_t y, uint16_t width,
                              uint16_t height, uint8_t progress) {}
void Display::drawFastImage(int16_t x, int16_t y, int16_t width, int16_t height,
                            const uint8_t* image) {}
...
void Display::drawStringMaxWidth(int16_t x, int16_t y, int16_t maxLineWidth,
                                 String text) {
	msg_queue_display msg;
