...
class Alarm : public App {
   ...
   private:
	...
	timestamp alarm1_timestamp, alarm2_timestamp, alarm3_timestamp,
		timer_timestamp;
	SemaphoreHandle_t mutex_alarm1, mutex_alarm2, mutex_alarm3;
	bool blink, alarm1, alarm2, alarm3, alarm1_ringing, alarm2_ringing,
		alarm3_ringing;
	bool alarm_off();
	...
	unsigned int buzzer_pattern_time[8] = {500, 500, 500, 500,
	                                       500, 500, 500, 1500};
	unsigned int buzzer_pattern_frequency[8] = {2000, 2000, 2000, 2000,
	                                            2000, 2000, 2000, 2000};
